                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-sm-12 col-lg-6 mb-4 pt-4">
                            ...
                            <div className="mt-4">
                                ...
                                <div className="d-flex justify-content-between mt-3">
                                    ...
                                    <div className="putOnMarketplace border-radius border"><img src={unlock} width="32" alt="" /> <b>Time auction</b>
                                    </div>
                                    <div className="putOnMarketplace border-radius border"><img src={sonsuz} width="40" alt="" /> <b>Open for bids</b></div>
                                </div>
                                ...
                                <div className="prize-single-collectible d-flex flex-column">
                                    <div className="d-flex justify-content-between mt-3">
                                        <b><h5 className="color-ping">Unlock once Purchased</h5></b>
                                        <div className="custom-control custom-switch">
                        ...
                        <div className="col-sm-12 col-lg-5">
                            <div className="mt-5 border h-75 pl-2 pr-2 pt-4 pb-4">
                                <div className="d-flex">
                                    <h5><b>Royalties</b> </h5>
                                </div>
