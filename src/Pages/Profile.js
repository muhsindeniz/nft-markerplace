                            ...
                            <div className="position-relative">
                                ...
                                <div className="profile-info-position">
                                    ...
                                    <div className="w-100 mt-3 d-flex justify-content-between align-items-center">
                                        <button className="bg-white border edit-profile">Edit Profile</button>
                                        <button className="bg-white border profile-upload">
                        ...
                        <main className="profile-tab-menu">
                            ...
                            <Tabs defaultActiveKey="4" centered>
                                ...
                                <TabPane tab="Owned" key="2">
                                    <section className="liveAuction proile-liked-filter">
                                        <div className="row ">
                                        ...
                                        <div className="container-fluid">
                                            ...
                                            <div className="topSellerContent">
                                                <div className="row">
                                                    <div className="col-sm-12 col-lg-3 mb-4">
                                                        <div className="topSellerCard">
                                                            ...
                                                            <div className="topSellerUserInfo">
                                                                ...
                                                                <h5 className="color-ping"><b>Started following you</b></h5>
                                                                <small>8/8/2021, 3:57 PM</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-sm-12 col-lg-3 mb-4 d-mobile-none">
                                                        <div className="mr-3">
                                                            <h5><b>Filters</b></h5>
                                                            <button className="btn-light mr-2 mt-2">
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-12 col-lg-3 mb-4">
                                                        <div className="topSellerCard">
                                                            ...
                                                            <button className="btn-ping-passive  w-100 mb-3">Follow</button>
                                                        </div>
                                                    </div>
