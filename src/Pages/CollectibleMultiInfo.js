            ...
            <div className="row">
                <div className="col-sm-12 d-flex align-items-center">
                    <svg width="24" height="24" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Link to="/CreateCollectibleMulti"> <h5 className="ml-3 mb-0">Back</h5> </Link>
                </div>
                ...
                <div className="col-sm-12 col-lg-6 mb-5 mobile-sm-order-right">
                    ...
                    <div className="mt-5">
                        ...
                        <div className="mt-5">
                            ...
                            <div className="mt-2"><b><span className="color-gray">You will receive </span> <span>0 ETH</span></b></div>
                        </div>

                        <div className="d-flex justify-content-between mt-5">
                            <b><h5 className="color-ping">Put on marketplace</h5></b>
                            <div className="custom-control custom-switch">
