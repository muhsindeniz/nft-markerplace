            ...
            <motion.section
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-sm-12 col-lg-6">
                            ...
                            <div className="mt-4">
                                ...
                                <div className="d-flex justify-content-between mt-3 row">
                                    ...
                                    <div className="putOnMarketplace border-radius border col-sm-12 col-lg-5"><img src={sonsuz} width="40" alt="" /> <b>Open for bids</b></div>
                                </div>
                        ...
                        <div className="col-sm-12 col-lg-6">
                            <div className="mt-5 border h-75 p-4">
                                <div className="d-flex">
                                    <h5><b>Royalties</b> </h5>
                                </div>
