            ...
            <section className="create-single-section-container following-page-section">
                <div className="container d-flex">
                    ...
                    <div className="row w-100">
                        ...
                        <div className="col-sm-12 d-flex mt-5 w-100 justify-content-center flex-column text-center">

                            <div className="tab-content w-100 d-flex justify-content-center flex-column align-items-center" id="myTabContent">
