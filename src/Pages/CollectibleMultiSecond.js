...
import multiBanner from "../assets/img/custom/multiple-info-card.png";
import { motion } from "framer-motion"
import {
    Link
} from "react-router-dom";
const CollectibleMultiSecond = () => {
        ...
        <motion.section
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-sm-12 col-lg-6 mb-5 mobile-sm-order-right pt-5">
                        <b className="mt-5">Upload File</b>

                        <div className="upload-file-container">
                            <div className="color-gray">
                                <img src={multiBanner} width="300" alt="" />
                            </div>
                        </div>
                        ...
                        <div className="mt-5">
                            ...
                            <div className="d-flex justify-content-between mt-4">
                                <b><h5 className="color-orange">Unlock once Purchased</h5></b>
                                <div className="custom-control custom-switch">
                                    <input type="checkbox" className="custom-control-input" id="customSwitch1" />
                                    <label className="custom-control-label" for="customSwitch1"></label>
                                </div>
                            ...
                            <b><h5 className="mt-5">Choose collection</h5></b>
                            <div className="d-flex mt-3">
                                <div className="putOnMarketplace border-radius border"><img src={plus} width="40" alt="" /><b> Create</b>
                                    <div><small className="color-gray">ERC-721</small></div>
                                </div>
                                <div className="putOnMarketplace ml-3 border-radius btn-primary-outline-responsive"><img src={darkCircle} width="40" alt="" /> <b>--------</b>
                            ...
                            <div className="mt-5">
                                <div className="d-flex">
                                    <h5><b>Properties</b> </h5><span className="color-gray ml-2">(Optional)</span>
                                </div>
                            ...
                            <div className="mt-5">
                                <div className="d-flex">
                                    <h5><b>Alternative text for NFT</b> </h5><span className="color-gray ml-2">(Optional)</span>
                                </div>

                                <div className="d-flex">
                                    <div className="prize-single-collectible w-100">
                                        <input type="text" placeholder="Image description in detail (Don’t start the with word 'Image'" />
                                    </div>
                                </div>
                    ...
                    <div className="col-sm-12 col-lg-3 mobile-sm-order-left pt-5">
                        <h5><b>Preview</b> </h5>
                            ...
                            <div className="liveAuction-card-container">
                                ...
                                <div className="bg-white p-4">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="text-danger"><b>Place a bid</b></div>
...
export default CollectibleMultiSecond
