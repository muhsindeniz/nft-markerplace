    ...
    return (
        ...
        <div className="border-radius bg-white p-4 popup-width">
            ...
            <div className="mt-3">
                ...
                <div className="pt-2 pb-2 border-bottom d-flex justify-content-between prize-single-collectible">
                    <input type="text" placeholder="Some words about the token collection" className=" w-100 " />
                </div>
            </div>
            ...
            <div className="mt-3">
                <div className="d-flex">
                    <h5><b>Custom URL</b></h5> <span className="color-gray ml-2">(Will be used as public profile)</span>
                </div>

                <div className="pt-2 pb-2 border-bottom d-flex justify-content-between prize-single-collectible">
                    <span className="color-gray mr-2">starlight.com/</span>
                    <input type="text" placeholder="Enter your custom URL  " className=" w-100 " />
                </div>
                <p className="color-gray">
